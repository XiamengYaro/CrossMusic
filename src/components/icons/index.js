// SVG Icon paths - Lucide-style flat modern icons
export const icons = {
  // Navigation
  ...
  volume2: `<polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M19.07 4.93a10 10 0 010 14.14M15.54 8.46a5 5 0 010 7.07"/>`,
  ...
  playlist: `<path d="M21 15V6"/><path d="M18.5 18a2.5 2.5 0 100-5 2.5 2.5 0 000 5z"/><path d="M12 12H3"/><path d="M16 6H3"/><path d="M12 18H3"/>`,
  ...
  gauge: `<path d="M12 2a10 10 0 0 0-10 10c0 4.4 2.9 8.2 6.9 9.5.4.1.8-.2.8-.6v-2.1c0-.3-.2-.6-.5-.7-2-1-3.4-3-3.4-5.4A6.2 6.2 0 0 1 12 6.4a6.2 6.2 0 0 1 6.2 6.3c0 2.4-1.4 4.4-3.4 5.4-.3.1-.5.4-.5.7v2.1c0 .4.4.7.8.6 4-1.3 6.9-5.1 6.9-9.5A10 10 0 0 0 12 2z"/><path d="M12 12m-2 0a2 2 0 1 0 4 0 2 2 0 1 0-4 0"/>`,
